import { defineComponent, openBlock, createBlock, createCommentVNode, createVNode, withModifiers, withDirectives, Fragment, renderList, vShow, resolveComponent, withCtx, renderSlot, toRefs, ref, reactive, mergeProps, provide, computed as computed$1, inject, toDisplayString, watchEffect, createStaticVNode, createTextVNode } from 'vue';
...
function render$h(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", {
    ...
    createVNode("div", {
      ...
      onClick: _cache[1] || (_cache[1] = withModifiers((...args) => (_ctx.clickBlock(...args)), ["stop"]))
    }, null, 6 /* CLASS, STYLE */),
...
var script$c = defineComponent({
    ...
    setup(props, context) {
        ...
        let subMenuClassName = computed$1(() => {
...
var script$b = defineComponent({
    ...
    setup(props, context) {
        ...
        let menuItemClassName = computed$1(() => {
            return `${baseCls} ${className.value} 
            ${active.value ? baseCls + '-active' : ''} 
            ${hidden.value ? baseCls + '-hidden' : ''} 
            ${disabled.value ? baseCls + '-disabled' : ''}
    ...
    createVNode("button", {
      ...
      (_ctx.text || _ctx.slotDefault)
        ? (openBlock(), createBlock("span", {
            ...
            (_ctx.text)
              ? (openBlock(), createBlock("span", _hoisted_1$1, toDisplayString(_ctx.text), 1 /* TEXT */))
              : renderSlot(_ctx.$slots, "default", { key: 1 })
          ], 2 /* CLASS */))
        : createCommentVNode("v-if", true),
      (_ctx.hotkey)
...
var script$a = defineComponent({
    ...
    setup() {
        let menuContext = inject('menuContext');
        let baseCls = menuContext.baseCls;
        let menuDividerClassName = computed$1(() => {
            return `${baseCls}-item 
...
var script$8 = defineComponent({
    ...
    setup(props, context) {
        ...
        let baseCls = `${prefixCls}-item`;
        let removeDocClickEvent = ref('');
        let currentMenuActived = computed$1(() => {
            return menubarActived.value && active.value
        });
        let menubarItemClass = computed$1(() => {
            return `${baseCls} 
            ${hidden.value ? baseCls + '-hidden ' : ''}
        ...
        let menubarItemTextClass = computed$1(() => {
            return `${baseCls}-text 
...
var script$3 = defineComponent({
    ...
    setup(props) {
        ...
        let isVertical = computed$1(() => {
            return split.value === 'vertical'
        });

        let isPrimaryFirst = computed$1(() => {
        ...
        let splitBoxClassName = computed$1(() => {
            return `${baseCls.value} 
...
var script$2 = defineComponent({
    ...
    setup(props, context) {
        ...
        let toolbarClassName = computed$1(() => {
            return `${baseCls.value} ${className.value} 
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", { class: _ctx.groupClassName }, [
    renderSlot(_ctx.$slots, "default")
  ], 2 /* CLASS */))
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (_ctx.slotDropdown)
    ? createVNode(_component_Dropdown, mergeProps({ key: 0 }, _ctx.buttonProps, { tAppendTo: "parent" }), {
        visible: withCtx(() => [
    ...
    : (openBlock(), createBlock("div", mergeProps({ key: 1 }, _ctx.buttonProps), [
        createVNode("button", {
          type: "button",
          class: `${_ctx.baseCls}-button`,
          onClick: _ctx.handleClick
