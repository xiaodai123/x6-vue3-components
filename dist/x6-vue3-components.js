(function (global, factory) {
  ...
  var script$d = {
      ...
      setup(props, context) {
          let { className, unregisterHotkey, registerHotkey, autoHotkey, onClick, hasIcon, stopPropagation } = vue.toRefs(props);
          let prefixCls = vue.ref('x6');
          ...
          vue.createVNode("button", {
            ...
            (_ctx.text || _ctx.slotDefault)
              ? (vue.openBlock(), vue.createBlock("span", {
                  ...
                  (_ctx.text)
                    ? (vue.openBlock(), vue.createBlock("span", _hoisted_1$3, vue.toDisplayString(_ctx.text), 1 /* TEXT */))
  ...
  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", { className: _ctx.groupClassName }, [
      vue.renderSlot(_ctx.$slots, "default")
    ], 8 /* PROPS */, ["className"]))
  }
