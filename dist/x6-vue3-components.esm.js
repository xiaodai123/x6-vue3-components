import { openBlock, createBlock, createCommentVNode, createVNode, withModifiers, withDirectives, Fragment, renderList, vShow, resolveComponent, withCtx, renderSlot, toRefs, ref, reactive, mergeProps, provide, computed, inject, toDisplayString, watchEffect, createStaticVNode, createTextVNode } from 'vue';
...
script$h.__file = "src/colorPicker/ColorPicker.vue";
...
function render$g(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_Tippy, { target: "_parent" }, {
    default: withCtx(() => [
...
script$g.__file = "src/tooltip/Tooltip.vue";
...
script$f.__file = "src/dropdown/Dropdown.vue";
...
script$e.__file = "src/contextMenu/ContextMenu.vue";
...
script$d.__file = "src/menu/Menu.vue";
...
script$c.__file = "src/menu/SubMenu.vue";
...
script$b.__file = "src/menu/MenuItem.vue";
...
function render$a(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", { class: _ctx.menuDividerClassName }, null, 2 /* CLASS */))
}

script$a.render = render$a;
script$a.__file = "src/menu/Divider.vue";
...
script$9.__file = "src/menubar/Menubar.vue";
...
script$8.__file = "src/menubar/MenubarItem.vue";
...
script$7.__file = "src/overlayscrollbars-vue3/OverlayScrollbarsComponent.vue";
...
script$6.__file = "src/scrollbox/Scrollbox.vue";
...
script$4.__file = "src/splitBox/Resizer.vue";
...
script$3.__file = "src/splitBox/SplitBox.vue";
...
script$2.__file = "src/toolbar/Toolbar.vue";
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", { className: _ctx.groupClassName }, [
    renderSlot(_ctx.$slots, "default")
  ], 8 /* PROPS */, ["className"]))
}

script$1.render = render$1;
script$1.__file = "src/toolbar/Group.vue";
...
script.__file = "src/toolbar/Item.vue";
